...
<project script = "zproject.gsl" name = "zproject"
    ...
    <!-- Jenkins target creates jenkins pipeline
         ...
         default this option is disabled if not set explicitly. Same
         goes for build_with_docs as it requires asciidoc and xmlto.
    ...
    <target name = "jenkins">
        ...
        <option name = "build_with_docs" value = "1" />
